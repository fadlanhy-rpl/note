...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laravel\note\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laravel\\note\\public\\storage',
...
'sanctum.csrf-cookie','login','register','logout','home','notes.search','notes.archive-toggle',
'notes.create','notes.store','notes.show','notes.edit','notes.update',
'notes.destroy','labels.manage','labels.index','labels.create','labels.store',
'labels.show','labels.update','labels.destroy','reminders.index','archive.index',
'archive.unarchive','trash.index','trash.restore','trash.permanent-delete','trash.empty',
'settings.index','profile.edit','help','storage.local',);
        registerArgumentsSet('views', 
'auth.login','auth.register','layouts.app','notes.create','notes.edit',
'notes.index','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
